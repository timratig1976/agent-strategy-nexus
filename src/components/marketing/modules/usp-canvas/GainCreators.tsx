    ...
    <div className="space-y-6">
      <div className="bg-emerald-50 p-4 rounded-lg">
        ...
        <p className="text-sm text-emerald-700">
          ...
          They explicitly outline how you intend to produce outcomes and benefits that your customer expects, desires, or would be surprised by.
        </p>
      </div>

...
const GainCreators = ({ creators, gains, onAdd, onUpdate, onDelete, formPosition = 'bottom' }: GainCreatorsProps) => {
  return (
    <RelatedItemList
      title="Gain Creators"
      description="Describe how your products and services create customer gains. These are the features that produce outcomes and benefits that your customer expects, desires, or would be surprised by."
      bgColor="green"
      titleColor="green"
      textColor="green"

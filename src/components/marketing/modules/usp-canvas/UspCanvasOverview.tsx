...
import { CustomerProfileSummary, ValueMapSummary, ValuePropositionFit, FitProgressBar } from "./overview";

interface UspCanvasOverviewProps {
  canvas: UspCanvas;
}

const UspCanvasOverview: React.FC<UspCanvasOverviewProps> = ({ canvas }) => {
  return (
